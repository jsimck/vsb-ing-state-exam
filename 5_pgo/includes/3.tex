...
\subsubsection{Tečný a normálový vektor křivky}
...
\begin{itemize}
	...
	\item Neuniformnost znamená, že parametry $t$ můžou nabývat různých hodnot i mimo interval $<0,1>$ a pro každou část můžou být jinak \uv{rychlé}
			\begin{equation*} 
		\begin{array}{c}
